                ...
                <div class="col-md-6 col-lg-8 d-flex flex-column align-items-stretch justify-content-center justify-content-lg-start">
                    ...
                    <div class="">
                        ...
                        <div class="row skills text-center">
                            ...
                            <div class="col-sm-3 col-4">
                                <div class="" id="angular" style="margin-bottom: 0.5rem;">
                                    <img src="/img/angular.png" style="margin-top: 0.6em; height: 3em">
                                </div>
                                <h5>Angular</h5>
                            </div>
                            <div class="col-sm-3 col-4">
                                <div class="" id="json" style="margin-bottom: 0.5rem;">
                                    <img src="/img/json.png" style="margin-top: 0.6em; height: 3em">
                                </div>
                                <h5>JSON</h5>
                            </div>
                            <div class="col-sm-3 col-4">
                                <div class="" id="github" style="margin-bottom: 0.5rem;">
                                    <img src="/img/github-mark.png" style="margin-top: 0.6em; height: 3em">
                                </div>
                                <h5>GitHub</h5>
                            </div>
                            <div class="col-sm-3 col-4">
                                <div class="" id="figma" style="margin-bottom: 0.5rem;">
                                    <img src="/img/figma.png" style="margin-top: 0.6em; height: 3em">
                                </div>
                                <h5>Figma</h5>
                            </div>
                        </div>
            ...
            <div class="swiper mySwiper2">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="img/plants1.jpg" />
                        <div class="label">
                            <?= Yii::t('translations', 'I am addicted to plants') ?>
                        </div>

                    </div>
                    <div class="swiper-slide">
                        <img src="img/cat.jpg" />
                        <div class="label"><?= Yii::t('translations', 'I dream of having a cat') ?></div>
                    </div>
                    <div class="swiper-slide">
                        <img src="img/piano.jpg" />
                        <div class="label"><?= Yii::t('translations', 'I play guitar and piano') ?></div>
                    </div>
                    <div class="swiper-slide">
                        <img src="img/languages.jpg" />
                        <div class="label"><?= Yii::t('translations', 'I studied 6 languages (although some of them remained at the elementary level)') ?></div>
                    </div>
                    <div class="swiper-slide">
                        <img src="img/soup.jpg" />
                        <div class="label"><?= Yii::t('translations', 'I enjoy cooking, especially soups') ?></div>
                    </div>
                    <div class="swiper-slide">
                        <img src="img/tea.jpg" />
                        <div class="label"><?= Yii::t('translations', 'I drink a looooot of tea') ?></div>
                    </div>
                    <div class="swiper-slide">
                        <img src="img/winner.jpg" />
                        <div class="label"><?= Yii::t('translations', 'In 2021 I won an award from \'She is Science\' for the best essay about female scientist') ?></div>
                    </div>
                </div>
